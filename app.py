...
<p style='font-size:18px;'>Check your loan approval chances instantly using machine learning.</p>
...
if st.session_state.step == 1:
    ...
    if st.button("Predict Loan Approval"):
        ...
        with col1:
            ...
            if probability>0.7:
                st.write("Strong approval likelihood. Your financial profile looks healthy.")

            elif probability>0.4:
                st.write("Moderate approval chance. Loan approval depends on lender policies.")

            else:
                st.write("High risk profile. Improving income or credit history may help.")
